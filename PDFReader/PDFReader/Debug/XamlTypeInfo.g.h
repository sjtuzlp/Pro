...
namespace XamlTypeInfo
{
    namespace InfoProvider
    {
        ...
        public:
            ...
            virtual Windows::UI::Xaml::Markup::IXamlMember^ GetMember(Platform::String^);
            virtual void AddToVector(Platform::Object^, Platform::Object^);
            virtual void AddToMap(Platform::Object^, Platform::Object^, Platform::Object^);
            virtual void RunInitializer();
            virtual Platform::Object^ CreateFromString(Platform::String^);

        private:
            Platform::String^ _fullName;
        };

        ref class XamlUserType sealed : public Windows::UI::Xaml::Markup::IXamlType
        {
        internal:
        ...
        internal:
            ...
            typedef Platform::Object^ (*StringConverterFn)(XamlUserType^ userType, Platform::String^ input);
